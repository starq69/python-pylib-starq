...
static struct PyModuleDef moduledef = {
    ...
    "pylib_starq._pylib_starq", /* m_name */
    NULL,             /* m_doc */
    -1,               /* m_size */
...
#else
    module = Py_InitModule3("pylib_starq._pylib_starq", module_functions, NULL);
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_pylib_starq(void) {
    moduleinit();
}
#else
PyMODINIT_FUNC PyInit__pylib_starq(void) {
    return moduleinit();
}
#endif
